...
const NODE_ICONS = [
  // 01 compass
  (
    <g key="compass" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  (
    <g key="id-card" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  // 03 sitemap
  (
    <g key="sitemap" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  (
    <g key="wireframe" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  // 04 code brackets </>
  (
    <g key="code" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  // 05 shield-check
  (
    <g key="shield" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  (
    <g key="rocket" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 17 L17 7" />
    ...
    <section id="process" className="spine" ref={sectionRef}>
      ...
      <div className="spine__rows">
        ...
        >
          <defs>
            ...
            <radialGradient id="spineHaloD">
              <stop offset="0%" stopColor="rgba(74, 120, 255, 0.4)" />
              <stop offset="60%" stopColor="rgba(74, 120, 255, 0.12)" />
              <stop offset="100%" stopColor="rgba(74, 120, 255, 0)" />
            </radialGradient>
          ...
          {NODES_DESKTOP.map((n, i) => (
            <g key={i} transform={`translate(${n.x} ${n.y})`}>
              ...
              >
                ...
                <circle r="6" fill="currentColor" className="spine__node-dot" />
                <NodeLabel index={i} />
              </g>
            </g>
          ))}
          ...
          {!reduced && (
            <circle r="4" fill="var(--blue)" filter="url(#spinePulseD)">
        ...
        >
          ...
          {!reduced && (
            <circle r="4" fill="var(--blue)" filter="url(#spinePulseM)">
