...
const COMPANY_LOGOS = [
  { name: "House of Eleven", src: "/logos/houseof11.webp" },
  { name: "IBS Consultants", src: "/logos/ibs.webp" },
  { name: "Covspace", src: "/logos/covspace.webp" },
  { name: "Ronspire", src: "/logos/ronspire.svg" },
  { name: "Perpex B-School", src: "/logos/perpexbschool.svg" },
  { name: "Perpex Group", src: "/logos/perpex.webp" },
  { name: "Mathlete", src: "/logos/mathlete.webp" },
  { name: "The Magnates", src: "/logos/themagnates.svg" },
  { name: "UniGo", src: "/logos/unigo.webp" },
  { name: "Soumya Shyam", src: "/logos/soumyashyam.webp" },
  { name: "Nutriboxx", src: "/logos/nutriboxx.webp" },
